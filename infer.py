...
if __name__ == '__main__':
    ...
    project_name = "test"
    model_path = f'./checkpoints/{project_name}/model_ckpt_steps_1000000.ckpt' # change ckpt file name to your best ckpt file name
    config_path = f'./checkpoints/{project_name}/config.yaml'

    # Support multiple wav/ogg files, put them in the raw folder, with extension
    file_names = ["Armani White - BILLIE EILISH._(Vocals).wav"]
